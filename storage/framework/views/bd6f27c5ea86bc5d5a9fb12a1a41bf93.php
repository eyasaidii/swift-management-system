                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <?php if($msg->mt_content): ?>
                                        <a href="<?php echo e(route('swift.view-mt', $msg->id)); ?>" class="btn btn-outline-success" title="Voir MT" target="_blank">
                                            <i class="fas fa-file-alt"></i> View MT
                                        </a>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eya saidi\Desktop\btl-swift-platform\btl-swift-platform-main\btl-swift-platform-main\resources\views/swift/index.blade.php ENDPATH**/ ?>