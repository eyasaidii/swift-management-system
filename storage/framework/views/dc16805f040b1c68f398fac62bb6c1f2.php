...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('international-admin.dashboard')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #6c757d !important;">
                <div class="card-body text-center py-3">
                    <div class="fs-1 fw-bold text-secondary"><?php echo e($totalAnomalies); ?></div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #dc3545 !important;">
                <div class="card-body text-center py-3">
                    <div class="fs-1 fw-bold text-danger"><?php echo e($highCount); ?></div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #ffc107 !important;">
                <div class="card-body text-center py-3">
                    <div class="fs-1 fw-bold text-warning"><?php echo e($mediumCount); ?></div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #198754 !important;">
                <div class="card-body text-center py-3">
                    <div class="fs-1 fw-bold text-success"><?php echo e($avgScore); ?></div>
                ...
                <div class="card-body d-flex flex-column align-items-center justify-content-center gap-3">
                    ...
                    <div class="d-flex gap-3 flex-wrap justify-content-center">
                        <span class="badge bg-success px-3 py-2">
                            <i class="fas fa-check-circle me-1"></i>LOW : <?php echo e($anomalyByLevel['LOW'] ?? $anomalyByLevel['low'] ?? 0); ?>

                        </span>
                        <span class="badge bg-warning text-dark px-3 py-2">
                            <i class="fas fa-exclamation-triangle me-1"></i>MEDIUM : <?php echo e($anomalyByLevel['MEDIUM'] ?? $anomalyByLevel['medium'] ?? 0); ?>

                        </span>
                        <span class="badge bg-danger px-3 py-2">
                            <i class="fas fa-skull-crossbones me-1"></i>HIGH : <?php echo e($anomalyByLevel['HIGH'] ?? $anomalyByLevel['high'] ?? 0); ?>
            ...
            <div class="card border-0 bg-light shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-3 py-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('swift.anomalies.index', ['niveau_risque' => 'HIGH'])); ?>"
...
new Chart(document.getElementById('chartByType'), {
    type: 'bar',
    data: {
        labels: <?php echo json_encode(array_keys($anomalyByType)); ?>,
        datasets: [{
            label: 'Anomalies (MEDIUM + HIGH)',
            data: <?php echo json_encode(array_values($anomalyByType)); ?>,
...
new Chart(document.getElementById('chartTimeline'), {
    type: 'line',
    data: {
        labels: <?php echo json_encode(array_column($scoreTimeline, 'jour')); ?>,
        datasets: [{
            label: 'Score moyen IA',
            data: <?php echo json_encode(array_column($scoreTimeline, 'avg_score')); ?>,
            borderColor: '#f59e0b',
