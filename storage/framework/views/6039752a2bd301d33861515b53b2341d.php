    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="<?php echo e(route('swift.anomalies.index')); ?>"
               class="btn <?php echo e($criticalCount > 0 ? 'btn-danger' : 'btn-warning'); ?> position-relative">
                <i class="fas fa-brain me-2"></i>Anomalies IA
                <?php if($totalAnomalies > 0): ?>
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill <?php echo e($criticalCount > 0 ? 'bg-light text-danger' : 'bg-dark'); ?>">
                        <?php echo e($totalAnomalies); ?>

                    </span>
                <?php endif; ?>
            </a>
            
            <a href="<?php echo e(route('swift.export-center')); ?>" class="btn btn-info">
                <i class="fas fa-download me-2"></i>Exporter Tout
            </a>
            <a href="<?php echo e(route('swift.index')); ?>" class="btn btn-success">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-danger w-50">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white text-center shadow">
                <div class="card-body">
                    <h6>Reçus</h6>
                    <h3><?php echo e($receivedCount ?? 0); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-success text-white text-center shadow">
                <div class="card-body">
                    <h6>Émis</h6>
                    <h3><?php echo e($emittedCount ?? 0); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
