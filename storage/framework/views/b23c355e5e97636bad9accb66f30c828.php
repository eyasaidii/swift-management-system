...
<?php $__env->startSection('title', 'Dashboard Backoffice - BTL Bank'); ?>
<?php $__env->startSection('page-title', 'Backoffice'); ?>
...
<div style="max-width:1400px;">
    ...
    <div class="dash-header">
        ...
        <div class="dash-btns">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export', App\Models\MessageSwift::class)): ?>
                <a href="<?php echo e(route('swift.export-center')); ?>" class="dbtn dbtn-gray"><i class="fas fa-download"></i> Export Center</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <?php if(isset($volumeParDevise) && count($volumeParDevise) > 0): ?>
    <div class="tbl-card mb-4">
        ...
        <div class="p-3">
            <div class="row g-3">
                <?php $__currentLoopData = $volumeParDevise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-md-3">
                    <div style="background:#f9fafb;border-radius:8px;padding:.7rem 1rem;text-align:center;border:1px solid #f3f4f6;">
                        <div style="font-size:.7rem;font-weight:700;color:#6b7280;text-transform:uppercase;"><?php echo e($vol->devise); ?></div>
                        <div style="font-size:1.1rem;font-weight:700;color:#111827;"><?php echo e(number_format($vol->total ?? 0,0,',',' ')); ?></div>
                        <div style="font-size:.65rem;color:#9ca3af;"><?php echo e($vol->nb ?? 0); ?> transaction(s)</div>
                    </div>
                </div>
    ...
    <div class="filt-card">
        ...
        <form method="GET" action="<?php echo e(route('backoffice.dashboard')); ?>" class="row g-2 align-items-end">
            <div class="col-6 col-md-3">
            ...
            <div class="col-6 col-md-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('backoffice.dashboard')); ?>" class="btn btn-sm btn-light flex-fill" style="font-size:.73rem;border:1px solid #e5e7eb;"><i class="fas fa-times"></i></a>
            </div>
        </form>
    </div>
            ...
            <table class="swift-tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div style="font-weight:600;font-size:.78rem;"><?php echo e(Str::limit($msg->sender_name ?? $msg->sender_bic ?? 'N/A',22)); ?></div></td>
                        ...
                        <td>
                            <div class="tbl-actions">
                                ...
                                <a href="<?php echo e(route('swift.pdf',$msg->id)); ?>" target="_blank" class="ta-btn ta-pdf"><i class="fas fa-file-pdf"></i></a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/backoffice/dashboard.blade.php ENDPATH**/ ?>