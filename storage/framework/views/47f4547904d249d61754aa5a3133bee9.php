        ...
        <div class="col-6 col-lg-4">
            <div class="kpi-card kpi-green">
                ...
                <?php if(isset($volumeByDevise) && count($volumeByDevise) > 1): ?>
                    <div class="kpi-sub"><?php $__currentLoopData = $volumeByDevise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($d); ?>: <?php echo e(number_format($v,0)); ?>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
                <?php endif; ?>
    ...
    <div class="filt-card">
        ...
        <form method="GET" action="<?php echo e(route('swift-operator.dashboard')); ?>" class="row g-2 align-items-end">
            ...
            <div class="col-6 col-md-2 d-flex gap-2">
                ...
                <a href="<?php echo e(route('swift-operator.dashboard')); ?>" class="btn btn-sm btn-light flex-fill" style="font-size:.73rem;border:1px solid #e5e7eb;"><i class="fas fa-times"></i></a>
            </div>
        </form>
    </div>
            ...
            <table class="swift-tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php if(in_array($dir,['IN','RECU'])): ?><span class="dir-in">Re&ccedil;u</span><?php else: ?><span class="dir-out">&Eacute;mis</span><?php endif; ?></td>
                        ...
                        <td style="font-family:monospace;font-size:.73rem;"><?php echo e(Str::limit($msg->reference ?? '&mdash;',20)); ?></td>
                        <td><div style="font-weight:600;font-size:.78rem;"><?php echo e(Str::limit($msg->sender_name ?? $msg->sender_bic ?? 'N/A',18)); ?></div></td>
                        <td><div style="font-size:.78rem;"><?php echo e(Str::limit($msg->receiver_name ?? $msg->receiver_bic ?? 'N/A',18)); ?></div></td>
                        ...
                        <td>
                            <?php switch($msg->status):
                                case ('pending'): ?>   <span class="sbadge sb-pending"><i class="fas fa-clock" style="font-size:.6rem;"></i></span> <?php break; ?>
                                <?php case ('processed'): ?> <span class="sbadge sb-processed"><i class="fas fa-check-double" style="font-size:.6rem;"></i></span> <?php break; ?>
