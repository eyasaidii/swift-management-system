...
<?php $__env->startSection('title', 'Dashboard International User - BTL Bank'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h1 class="h2 mb-0 fw-bold">
                <i class="fas fa-globe-americas text-primary me-2"></i>International User
            </h1>
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('international-user.dashboard')); ?>" class="row g-3">
                <div class="col-md-2">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white text-center shadow">
                <div class="card-body">
                    <h6>Volume Traité</h6>
                    <h3><?php echo e(number_format($volume ?? 0, 2)); ?> <?php echo e($currency ?? 'USD'); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eya saidi\Desktop\btl-swift-platform\btl-swift-platform-main\btl-swift-platform-main\resources\views/international-user/dashboard.blade.php ENDPATH**/ ?>