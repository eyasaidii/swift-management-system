...
<?php $__env->startSection('page-title', 'Monétique'); ?>
...
<div style="max-width:1400px;">
    ...
    <div class="filt-card">
        ...
        <form method="GET" action="<?php echo e(route('monetique.dashboard')); ?>" class="row g-2 align-items-end">
            ...
            <div class="col-6 col-md-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('monetique.dashboard')); ?>" class="btn btn-sm btn-light flex-fill" style="font-size:.73rem;border:1px solid #e5e7eb;"><i class="fas fa-times"></i></a>
            </div>
        </form>
    </div>
