...
<?php $__env->startSection('title', "Dashboard Chef Agence - BTL Bank"); ?>
<?php $__env->startSection('page-title', "Chef d'Agence"); ?>
...
<div style="max-width:1400px;">
    ...
    <div class="dash-header">
        ...
        <div class="dash-btns">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\MessageSwift::class)): ?>
                <a href="<?php echo e(route('swift.create')); ?>" class="dbtn dbtn-green"><i class="fas fa-plus"></i> Nouveau message</a>
            <?php endif; ?>
    ...
    <div class="filt-card">
        ...
        <form method="GET" action="<?php echo e(route('chef-agence.dashboard')); ?>" class="row g-2 align-items-end">
            ...
            <div class="col-6 col-md-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('chef-agence.dashboard')); ?>" class="btn btn-sm btn-light flex-fill" style="font-size:.73rem;border:1px solid #e5e7eb;"><i class="fas fa-times"></i></a>
            </div>
        </form>
    </div>
                ...
                <tbody>
                        ...
                        <td>
                            <div class="tbl-actions">
                                ...
                                <?php if($msg->status == 'pending'): ?>
                                    <form method="POST" action="<?php echo e(route('swift.process',$msg->id)); ?>" class="d-inline" onsubmit="return confirm('Confirmer le traitement ?')">
                                        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                        <button type="submit" class="ta-btn ta-ok"><i class="fas fa-check"></i></button>
                                    </form>
                                    <form method="POST" action="<?php echo e(route('swift.reject',$msg->id)); ?>" class="d-inline" onsubmit="return confirm('Confirmer le rejet ?')">
                                        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    ...
                    <tr><td colspan="7">
                        <div class="empty-state">
                            ...
                            <small><a href="<?php echo e(route('swift.create')); ?>" style="color:#3b82f6;">Cr&eacute;er un nouveau message SWIFT</a></small>
                        </div>
                    </td></tr>
                    <?php endif; ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/chef-agence/dashboard.blade.php ENDPATH**/ ?>