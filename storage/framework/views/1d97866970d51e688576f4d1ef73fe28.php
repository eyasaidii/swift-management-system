...
<div class="container-fluid py-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('chargee.dashboard')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('chargee.dashboard')); ?>" class="btn btn-outline-danger w-50">
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="<?php echo e($msg->status == 'rejected' ? 'table-danger' : ($msg->status == 'pending' ? 'table-warning' : '')); ?>">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <small>
                                        <a href="<?php echo e(route('swift.create')); ?>">Créer votre premier message SWIFT</a>
                                    </small>
                                </td>
                            </tr>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eya saidi\Desktop\btl-swift-platform\btl-swift-platform-main\btl-swift-platform-main\resources\views/chargee/dashboard.blade.php ENDPATH**/ ?>