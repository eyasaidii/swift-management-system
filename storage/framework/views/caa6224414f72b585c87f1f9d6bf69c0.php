                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="type-badge <?php echo e($badgeClass); ?>">
                                    <?php echo e(strtoupper($msg->type_message ?? '?')); ?>

                                </span>
                            </td>

                            <td style="font-size:.8rem;color:#334155;">
                                <?php echo e(Str::limit($msg->sender_name ?? $msg->sender_bic ?? 'N/A', 28)); ?>

                            </td>

                            <td>
                                <span class="ref-cell" title="<?php echo e($msg->reference ?? ''); ?>">
                                    <?php echo e($msg->reference ?? 'N/A'); ?>
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    ...
                                    <button type="button"
                                            ...
                                            data-url="<?php echo e(route('swift.view-mt', $msg->id)); ?>"
                                            data-title="MT"
                                            title="Format MT">
                                    ...
                                    <button type="button"
                                            ...
                                            data-bs-target="#deleteModal<?php echo e($msg->id); ?>"
                                            title="Supprimer">
...
<?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade modal-delete" id="deleteModal<?php echo e($msg->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="ref-tag"><?php echo e(Str::limit($msg->reference ?? 'N/A', 30)); ?></div>
