                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 opacity-75">
                                <i class="fas fa-user me-1"></i> Bienvenue, <strong><?php echo e(auth()->user()->name); ?></strong>
                            </p>
                        </div>
                        <div class="text-end">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <?php if(Route::has('admin.users.index')): ?>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" class="quick-action-btn btn btn-outline-danger p-4">
                            ...
                            <div class="col-md-3 mb-3">
                                <?php if(Route::has('admin.configuration')): ?>
                                    <a href="<?php echo e(route('admin.configuration')); ?>" class="quick-action-btn btn btn-outline-primary p-4">
                            ...
                            <!-- Carte 3: Agences -->
                            <div class="col-md-3 mb-3">
                                <?php if(Route::has('admin.agencies')): ?>
                                    <a href="<?php echo e(route('admin.agencies')); ?>" class="quick-action-btn btn btn-outline-warning p-4">
                            ...
                            <!-- Carte 4: Monitoring -->
                            <div class="col-md-3 mb-3">
                                <?php if(Route::has('admin.system-monitoring')): ?>
                                    <a href="<?php echo e(route('admin.system-monitoring')); ?>" class="quick-action-btn btn btn-outline-info p-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3">
                            <?php if(Route::has('admin.users.index')): ?>
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-primary btn-lg">
                                    <i class="fas fa-users me-2"></i>Voir tous les utilisateurs
                                </a>
                            <?php endif; ?>
                            
                            <?php if(Route::has('profile.edit')): ?>
                                <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-secondary btn-lg">
