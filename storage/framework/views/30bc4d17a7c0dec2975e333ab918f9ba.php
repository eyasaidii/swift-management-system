...
<?php $__env->startSection('title', 'Dashboard International Admin - BTL Bank'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h1 class="h2 mb-0 fw-bold">
                <i class="fas fa-globe-americas text-primary me-2"></i>International
            </h1>
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('international-admin.dashboard')); ?>" class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('international-admin.dashboard')); ?>" class="btn btn-outline-danger w-50">
                        ...
                        <tr class="<?php echo e(match($status) { 'pending' => 'table-warning', 'processed' => 'table-info', 'suspended' => 'table-danger', default => '' }); ?>">
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    ...
                                    <?php if($hasMt): ?>
                                        <a href="<?php echo e(route('swift.view-mt', $tx->id)); ?>"
                                    ...
                                    <?php if($hasMx): ?>
                                        <a href="<?php echo e(route('swift.view-mx', $tx->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eya saidi\Desktop\btl-swift-platform\btl-swift-platform-main\btl-swift-platform-main\resources\views/international-admin/dashboard.blade.php ENDPATH**/ ?>