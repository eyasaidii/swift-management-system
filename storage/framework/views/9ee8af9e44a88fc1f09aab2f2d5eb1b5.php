        ...
        <div class="col-md-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted"><?php echo e($user->name); ?> - <?php echo e($user->email); ?></p>
                </div>
            ...
            <div class="card mt-4 border-danger">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-danger" onclick="confirmDelete(<?php echo e($user->id); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/super-admin/users/modifier.blade.php ENDPATH**/ ?>