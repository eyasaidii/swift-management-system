...
<?php echo e(\Carbon\Carbon::parse($tx->CREATED_AT ?? $tx->created_at)->format('d/m/Y H:i')); ?>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button type="button" class="btn btn-outline-success open-raw-file" data-url="<?php echo e(route('swift.view-mt', $tx->id)); ?>" data-title="MT"><i class="fas fa-file-alt"></i> MT</button>
                                    <a href="<?php echo e(route('swift.view-mx', $tx->id)); ?>" target="_blank" class="btn btn-outline-dark" title="MX"><i class="fas fa-code"></i> MX</a>
                                </div>
                            </td>
                        </tr>
