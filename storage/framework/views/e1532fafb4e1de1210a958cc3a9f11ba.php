...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h1 class="h2 mb-0 fw-bold"><i class="fas fa-tasks text-warning me-2"></i>Backoffice</h1>
            <p class="text-muted">Traitement et réconciliation des opérations quotidiennes</p>
        </div>
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('backoffice.dashboard')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('backoffice.dashboard')); ?>" class="btn btn-outline-danger w-50"><i class="fas fa-times me-2"></i>Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-header bg-white">
            <h5 class="mb-0"><i class="fas fa-chart-bar me-2 text-primary"></i>Volume reçu par devise</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <div class="card border text-center p-3">
                        <h6 class="text-muted mb-1"><?php echo e($vol->devise); ?></h6>
                        <h4 class="fw-bold mb-0"><?php echo e(number_format($vol->total, 0)); ?></h4>
                        <small class="text-muted"><?php echo e($vol->nb); ?> transaction(s)</small>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eya saidi\Desktop\btl-swift-platform\btl-swift-platform-main\btl-swift-platform-main\resources\views/backoffice/dashboard.blade.php ENDPATH**/ ?>