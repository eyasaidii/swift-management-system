...
<div class="main-wrapper">
    <header class="top-navbar">
        ...
        <div style="flex:1;">
            ...
            <div class="tn-title">@yield('page-title', 'SWIFT Messages')</div>
        </div>
        <div class="tn-user">
            <div>
                <div class="tn-uname">{{ auth()->user()->name }}</div>
                <div class="tn-urole">{{ $primaryRole ?? 'Utilisateur' }}</div>
            </div>
            <div class="tn-avatar">{{ $initials }}</div>
        </div>
    </header>
...
<script>
    {{-- ✅ Tooltips Bootstrap activés globalement --}}
