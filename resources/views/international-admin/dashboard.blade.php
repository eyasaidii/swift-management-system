...
@section('title', 'Dashboard International Admin - BTL Bank')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            {{-- Badge "Autorisations" = messages processed en attente d'autorisation --}}
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('international-admin.dashboard') }}" class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('international-admin.dashboard') }}" class="btn btn-outline-danger w-50">
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ match($status) { 'pending' => 'table-warning', 'processed' => 'table-info', 'suspended' => 'table-danger', default => '' } }}">
                            ...
                            {{-- ACTIONS : uniquement voir détail, MT et MX --}}
                            <td>
