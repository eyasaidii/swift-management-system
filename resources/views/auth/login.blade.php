...
@section('title', 'Connexion sécurisée - BTL Bank')
    ...
    <div class="card-wrap">
        <div class="login-card">
            ...
            <div class="card-header-section">
                <div class="logo-ring">
                    <img src="{{ asset('images/logo-btl.png') }}" alt="BTL Bank" height="52"
            ...
            <form method="POST" action="{{ route('login') }}" id="loginForm" autocomplete="off">
                ...
                <div class="field-group">
                    ...
                    @error('email')
                        <span class="field-error"><i class="fas fa-triangle-exclamation me-1"></i>{{ $message }}</span>
                    @enderror
                </div>
            ...
            <p class="card-footer-text">
                ...
                © {{ date('Y') }} BTL Bank — Accès réservé au personnel autorisé
            </p>
