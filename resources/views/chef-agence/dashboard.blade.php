{{-- resources/views/chef-agence/dashboard.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid py-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('chef-agence.dashboard') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('chef-agence.dashboard') }}" class="btn btn-outline-danger w-50">
                            ...
                            <tr class="{{ $msg->status == 'pending' ? 'table-warning' : '' }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        {{-- ✅ AJOUT : Traiter (uniquement si pending) --}}
                                        @if($msg->status == 'pending')
                                            <form method="POST"
                                                  action="{{ route('swift.process', $msg->id) }}"
                                                  class="d-inline"
                                            ...
                                            {{-- ✅ AJOUT : Rejeter (uniquement si pending) --}}
                                            <form method="POST"
                                                  action="{{ route('swift.reject', $msg->id) }}"
                                                  class="d-inline"
                                        ...
                                        {{-- Voir MT --}}
                                        <button type="button" class="btn btn-outline-secondary open-raw-file" data-url="{{ route('swift.view-mt', $msg->id) }}" data-title="MT">MT</button>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <small>
                                        <a href="{{ route('swift.create') }}">Créer un nouveau message SWIFT</a>
                                    </small>
                                </td>
                            </tr>
                        @endforelse
