...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="{{ route('admin.users.index') }}" class="btn btn-primary"><i class="fas fa-users me-2"></i>Gérer Utilisateurs</a>
            <a href="{{ route('swift.export-center') }}" class="btn btn-info"><i class="fas fa-download me-2"></i>Exporter Tout</a>
            <a href="{{ route('swift.index') }}" class="btn btn-success"><i class="fas fa-list me-2"></i>Messages SWIFT</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.dashboard') }}" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-outline-danger w-50"><i class="fas fa-times me-2"></i>Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white text-center shadow">
                <div class="card-body"><h6>Reçus</h6><h3>{{ $receivedCount ?? 0 }}</h3></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-success text-white text-center shadow">
                <div class="card-body"><h6>Émis</h6><h3>{{ $emittedCount ?? 0 }}</h3></div>
            </div>
        </div>
        <div class="col-md-3">
                                ...
                                @switch($status)
                                    ...
                                    @case('authorized')
                                        <span class="badge bg-success"
                                              @if($note) data-bs-toggle="tooltip" title="{{ $note }}" @endif>
                                            ✅ Autorisé
                                        </span>
                                    ...
                                    @case('suspended')
                                        <span class="badge bg-danger"
                                              @if($note) data-bs-toggle="tooltip" title="Motif: {{ $note }}" @endif>
                                            ⛔ Suspendu
                                        </span>
