...
<div class="container-fluid py-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('backoffice.dashboard') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('backoffice.dashboard') }}" class="btn btn-outline-danger w-50"><i class="fas fa-times me-2"></i>Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <div class="card border text-center p-3">
                        <h6 class="text-muted mb-1">{{ $vol->devise }}</h6>
                        <h4 class="fw-bold mb-0">{{ number_format($vol->total, 0) }}</h4>
                        <small class="text-muted">{{ $vol->nb }} transaction(s)</small>
                    </div>
                </div>
                @endforeach
            </div>
